...
Barreto_set is the classic LRP benchmark instances provided by Barreto et al. (2007).
...
Tuzun_and_Burke_set is provided by Tuzun & Burke (1999) with clients range from 100 to 200 and depots range from 10 to 20.
...
Citibike_set focus on large-scale LRP over 300 nodes and is adapted from the biggest shared bike system in New York, the Citi Bike.
